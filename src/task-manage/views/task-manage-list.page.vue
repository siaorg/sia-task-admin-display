<template>
<div class="dispatch-system-default task-manage-list-page" v-loading="loading" element-loading-text="加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.2)">
    <div class="section-container">
        ...
        <el-button class="btn-large edit-btn" @click="handleSearch">查询</el-button>
          ...
          <el-select v-model="searchProjectName" :multiple="false" placeholder="项目组名" filterable>
            ...
            <el-button class="btn-large edit-btn btn-ml-auto" @click="handleClickAddTask"> 添加Task </el-button>
        </div>
                    ...
                    <el-table :data="viewTaskManageList" style="width: 100%" class="task-manage-table">
                        ...
                        <el-table-column prop="taskAppName">
                            <template slot="header" slot-scope="scope">
                                <el-popover placement="bottom-start" popper-class="select-box-popver" :ref="item.taskGroupName" trigger="click">
                        ...
                        <el-table-column prop="taskKey" show-overflow-tooltip label="task名称" width="" min-width="120px">
                            <template slot="header" slot-scope="scope">
                                <el-popover placement="bottom-start" popper-class="select-box-popver" :ref="item.taskGroupName + index" trigger="click">
                        ...
                        <el-table-column prop="ipPost" label="OnLine 机器地址" min-width="100px">
                            <template slot-scope="scope">
                        ...
                        <el-table-column prop="taskDesc" label="描述" show-overflow-tooltip min-width="150px">
                        </el-table-column>
                        <el-table-column label="操作" width="240">
                            <template slot-scope="scope">
                                ...
                                <el-popover placement="top-end" width="200" popper-class="alert-detele-box" trigger="click" v-model="scope.row.check" :ref="scope.row.taskAppName + scope.$index">
                                    <p class="title">
                                        <span class="el-icon-warning"></span>
                                        <span>你确定要删除{{scope.row.taskKey}}吗？</span>
                                    </p>
                                    <div style="text-align: right;">
...
export default {
    ...
    methods: {
        handleSearch() {
          this.getTaskList(this.activeNames, this.searchApplyName, this.searchTaskName, this.pageSize, '1',this.descriptionInput)
        },
        // 连通性测试
            ...
            self.$http.get(self.$api.getApiAddress('/taskapi/selectGroupAndCount', 'CESHI_API_HOST'), {
                ...
                if (res.data.code === 0) {
                    ...
                    res.data.data.forEach(item => {
                        if (item.taskGroupName === this.$store.state.DeskTtopStore.curAppGroup) {
                            temArr.push(item)
                        }
                    })
                    self.searchListGroup = temArr
                    if (val !== '') {
        ...
        getSearchProjectList: function () {
            this.searchProjectName = this.$store.state.DeskTtopStore.curAppGroup
        },
        ...
        getTaskList(project, apply, task, pageSize, currentPageIndex, taskDesc ) {
            let self = this
