...
export default {
  ...
  methods: {
    getPreTaskKey: function () {
      let self = this
      let arr = []
      if (this.addTaskTagValue.valTaget.preTaskKey instanceof Array) {
      ...
      self.taskCreateViewModel.readTimeout = self.addTaskTagValue.valTaget.readTimeout ? self.addTaskTagValue.valTaget.readTimeout : (self.addTaskTagValue.valTaget.readTimeout === null ? self.addTaskTagValue.valTaget.readTimeout : '30')
      ...
      self.taskCreateViewModel.tasktransferFail = self.addTaskTagValue.valTaget.failover || 'STOP'
