      ...
      <el-tabs>
        <!-- <el-tab-pane label="资源分配详情"> -->
          ...
          <!-- <el-table  v-show="!showNoDataBox"
            ...
            <el-table-column show-overflow-tooltip label="漂移成功JOB">
              <template slot-scope="scope">
            ...
            <el-table-column show-overflow-tooltip label="漂移失败JOB">
              <template slot-scope="scope">
                <p class="is-fail-job">失败漂移Job({{transferListsData.transFailCount}}个):</p>
        ...
        <el-tab-pane label="调度器管理">
          <div class="dispatch-option">
            <div class="option-list">
              ...
              <div v-if="showDeleteWork.length>5" class="show-more-list" @click="showMoreListManage($event)"><span class="el-icon-d-arrow-right"></span></div>
            </div>
            <div class="option-list">
              <div class="title">
              ...
              <div v-if="showDeleteOff.length>5" class="show-more-list" @click="showMoreListManage($event)"><span class="el-icon-d-arrow-right"></span></div>
            </div>
            ...
            <div class="option-list">
              ...
              <div v-if="moveLineList.length>5" class="show-more-list" @click="showMoreListManage($event)"><span class="el-icon-d-arrow-right"></span></div>
            </div>
            <div class="option-list">
              <div class="title">
              ...
              <div class="table-box">
                ...
                <div v-if="nameBlackList.length>5" class="show-more-list" @click="showMoreListManage($event)"><span class="el-icon-d-arrow-right"></span></div>
              </div>
            </div>
          </div>
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    setTransferListData: function (params) {
      ...
      //   transFailCount: params.transFailedList.length,
      //   list: []
      // }
      // let success = []
